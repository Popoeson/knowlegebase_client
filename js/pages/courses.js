...
const init = async () => {
    ...
    <div class="course-card" onclick="window.location.href='./course-detail.html?id=${course._id}'">
        <div class="course-card-thumb">
            <p class="course-card-category">${Utils.escapeHTML(course.category?.name || "General")}</p>
            ${course.thumbnail
        ...
        <div class="course-card-body">
            ...
            <p class="course-card-desc">${Utils.escapeHTML(Utils.truncate(course.description, 100))}</p>
